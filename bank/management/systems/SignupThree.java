...
public class SignupThree extends JFrame implements ActionListener{   // extend JFrame here
    ...
    SignupThree( String formno) {
       ...
       card .setFont(new Font("Raleway", Font.BOLD, 22));
        ...
        JLabel number = new JLabel(" XXXX-XXXX-XXXX-3577");
       ...
       pin.setFont(new Font("Raleway", Font.BOLD, 22));
        ...
        JLabel pindetails = new JLabel("Your 4 Digit P{assword");
     ...
     if(ae.getSource()==submit){
        ...
        String cardnumber= "" +Math.abs((rd.nextLong()%9000000L)+504093600000000L);
    ...
    // insert into signupthree (5 columns, 5 values)
    String query1 = "insert into signupthree values('" + formno + "','" + accountType + "','" + cardnumber + "','" + pinnumber + "','" + facility + "')";
    conn.s.executeUpdate(query1);

    // insert into login (3 columns, 3 values)
